...
def plot_accuracies(train_accuracies, eval_accuracies):
    ...
    plt.legend()
    plt.savefig("./result-roberta-bitfit/train_accuracy_plot.png")
    plt.show()
    ...
    plt.legend()
    plt.savefig("./result-roberta-bitfit/dev_accuracy_plot.png")
    plt.show()
...
if __name__ == "__main__":
    ...
    training_args = TrainingArguments(
        ...
        learning_rate=1e-4,
        save_strategy="epoch",
        output_dir = "./result-roberta-bitfit",
        logging_dir = "./logs-roberta-bitfit",
